...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--target-dir",
        required=True,
        help="Dossier cible pour les images predites comme une autre espece",
    )
    parser.add_argument(
        "--model-path",
    ...
    parser.add_argument(
        ...
        default=0.0,
        help=(
            "Seuil minimal de confiance pour deplacer une image mal classee. "
            "A 0.0, toute prediction differente est deplacee."
        ),
    )
